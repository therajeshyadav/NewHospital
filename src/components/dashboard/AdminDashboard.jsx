...
+                { action: 'Dr. Johnson completed consultation', time: '15 minutes ago', type: 'consultation' },
+                { action: 'Appointment scheduled for tomorrow', time: '1 hour ago', type: 'appointment' },
+                { action: 'New doctor added to cardiology', time: '2 hours ago', type: 'staff' },
+                { action: 'Patient bill generated', time: '3 hours ago', type: 'billing' },
              ].map((activity, index) => (
